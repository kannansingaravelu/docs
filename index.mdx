---
title: "Introduction"
description: "Quantmod is a lightweight, structured toolkit for financial time-series ingestion, storage, and analysis, designed for data scientists, analysts, and AI practitioners. It is inspired by the popular R-package of the same name, reimagined for the modern Python data stack.
